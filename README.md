...
6. on calcule les embeddings localement;
7. on interroge le graphe avec `VectorCypherRetriever` et des filtres temporels.
...
4. ajoute ensuite un reranker open source;
5. plus tard, fine-tune l’embedding model ou le reranker sur tes données d’histoire chrétienne.
